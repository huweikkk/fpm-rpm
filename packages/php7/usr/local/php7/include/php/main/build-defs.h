...
#define CONFIGURE_COMMAND " './configure'  '--prefix=/usr/local/php7' '--with-config-file-path=/usr/local/php7/etc' '--with-mysql' '--with-mysqli' '--with-mysql-sock' '--with-pdo-mysql' '--with-gd' '--enable-libxml' '--enable-xml' '--enable-bcmath' '--enable-shmop' '--enable-sysvsem' '--enable-inline-optimization' '--enable-mbregex' '--enable-fpm' '--enable-mbstring' '--enable-ftp' '--enable-gd-native-ttf' '--with-openssl' '--enable-pcntl' '--enable-sockets' '--with-xmlrpc' '--enable-zip' '--enable-soap' '--without-pear' '--with-gettext' '--enable-session' '--with-mcrypt' '--with-curl' '--enable-ctype' '--with-jpeg-dir' '--with-png-dir' '--with-zlib' '--with-libxml-dir' '--with-mhash' '--with-iconv-dir' '--with-freetype-dir'"
...
#define PHP_EXTENSION_DIR       "/usr/local/php7/lib/php/extensions/no-debug-non-zts-20160303"
